...
import ToolbarPanel from "@/components/ToolbarPanel/ToolbarPanel.vue";
...
<template>
  <div class="flex flex-col h-screen w-screen">
    <!-- Toolbar с кнопками управления (resizable) -->
    <ResizablePanelGroup direction="vertical" class="h-full">
      <ResizablePanel :default-size="10" :min-size="0" :max-size="20">
        <div class="flex justify-between items-center p-2 border-b bg-gray-50 h-full">
          <LayoutMenu />
